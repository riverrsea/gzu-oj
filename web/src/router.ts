...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/contests/:contestId/problems/:problemId", component: () => import("./views/WorkspaceView.vue"), meta: { workspace: true } },
    { path: "/timed-papers/:timedPaperAttemptId/problems/:problemId", component: () => import("./views/WorkspaceView.vue"), meta: { workspace: true } },
    ...
    { path: "/contests/:contestId/ranking", component: () => import("./views/RankingsView.vue"), meta: { public: true } },
